...
INSERT INTO `project` VALUES (2,NULL,'Аххаахахааха','Тестовый проект №1',NULL),(3,NULL,'Тестовый проект №2','Проект №2',NULL);
...
INSERT INTO `task` VALUES (1,'АХахахха','15 минут','Задача №1','Высокий','Выполнен',1),(2,'Добавление','15 минут','нажать кнопку','Высокий','выполнен',2);
...
INSERT INTO `test` VALUES (1,NULL,NULL,'Тест контроллера №999','тест №1','А вот нет их','Пройден',1,2,NULL),(2,NULL,NULL,'добавление отдельно','тест добавления','выполнен','выполнен',1,2,NULL);
...
-- Dump completed on 2023-03-26 22:31:07
